...
obs1Pos = [60, 40]; % Position of object 1 (x, y)
...
obsS = 14;   % The spread of repulsion of the obstacle
alpha = 0.6; % Strength of attraction
beta = 0.8;  % Strength of repulsion
...
for y = 1:1:100
    for x = 1:1:100
        ...
        xnet = uG + uO1 + uO2;   % Net delta calculations for each point in the grid
        ynet = vG + vO1 + vO2;
